...
const socialLinks = [
  {
    icon: Mail,
    label: 'Email',
    href: 'mailto:krishkavathia27@gmail.com',
    description: 'Drop me a line',
    value: 'krishkavathia27@gmail.com',
  },
  {
    icon: Github,
    label: 'GitHub',
    href: 'https://github.com/Krish-1211',
    description: 'Check my code',
    value: 'github.com/Krish-1211',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/krish-kavathia',
    description: "Let's connect",
    value: 'linkedin.com/in/krish',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground text-center mt-6">
                ...
                <a href="mailto:krishkavathia27@gmail.com" className="text-accent hover:underline">
                  krishkavathia27@gmail.com
                </a>
              </p>
            </motion.div>
          </div>
